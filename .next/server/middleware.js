...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_C_3A_5CUsers_5CDen_5CDesktop_5CFrontend_main_matchers_)
});
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5CDen%5CDesktop%5CFrontend-main&matchers=!

        

        enhanceGlobals()

        var mod = __webpack_require__(492)
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_C_3A_5CUsers_5CDen_5CDesktop_5CFrontend_main_matchers_(opts) {
          return adapter({
              ...opts,
              page: "/middleware",
              handler,
...
var _addPathPrefix = __webpack_require__(899);
var _pathHasPrefix = __webpack_require__(247);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
...
var _parsePath = __webpack_require__(71);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
var _removeTrailingSlash = __webpack_require__(902);
var _addPathPrefix = __webpack_require__(899);
var _addPathSuffix = __webpack_require__(243);
var _addLocale = __webpack_require__(768);
function formatNextPathnameInfo(info) {
...
var _normalizeLocalePath = __webpack_require__(1);
var _removePathPrefix = __webpack_require__(703);
var _pathHasPrefix = __webpack_require__(247);
function getNextPathnameInfo(pathname, options) {
    var _nextConfig;
    const { basePath , i18n , trailingSlash  } = (_nextConfig = options.nextConfig) != null ? _nextConfig : {};
...
var _detectDomainLocale = __webpack_require__(946);
var _formatNextPathnameInfo = __webpack_require__(803);
var _getHostname = __webpack_require__(269);
var _getNextPathnameInfo = __webpack_require__(809);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|::1|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
/******/ var __webpack_exports__ = (__webpack_exec__(825));
