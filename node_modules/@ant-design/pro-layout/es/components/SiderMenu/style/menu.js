...
var genProLayoutBaseMenuStyle = function genProLayoutBaseMenuStyle(token) {
  ...
  return _defineProperty({}, "".concat(token.componentCls), (_$concat5 = {
    ...
    paddingInline: 0
  })), _collapsed)), _defineProperty(_$concat5, "".concat(token.componentCls, "-item-icon"), {
    height: '14px',
    width: '14px',
    opacity: '0.85',
    lineHeight: '14px',
    ...
    }), _defineProperty(_collapsed2, "".concat(token.componentCls, "-item-text"), {
      maxWidth: '100%'
    }), _defineProperty(_collapsed2, "".concat(token.componentCls, "-item-text-has-icon"), {
      display: 'none !important'
    }), _collapsed2)
  }, _defineProperty(_itemTitle, "&".concat(token.componentCls, "-group-item-title"), {
    gap: 4,
    height: 18,
    overflow: 'hidden'
...
export function useStyle(prefixCls) {
  return useAntdStyle('ProLayoutBaseMenu', function (token) {
