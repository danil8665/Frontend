...
var StatisticCard = function StatisticCard(props) {
  ...
  var chartCls = (0, _classnames.default)("".concat(prefixCls, "-chart"), hashId, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-chart-left"), chartPlacement === 'left' && chart && statistic), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-chart-right"), chartPlacement === 'right' && chart && statistic), _classNames));
  ...
  return wrapSSR((0, _jsxRuntime.jsxs)(_Card.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({
