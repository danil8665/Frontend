...
var Card = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  ...
  // 修改组合传给antd tabs的参数
  // @ts-ignore
  var ModifyTabItemsContant = (0, _TabPane.useLegacyItems)(tabs === null || tabs === void 0 ? void 0 : tabs.items, children, tabs);
  /**
  ...
  var childrenModified = childrenArray.map(function (element, index) {
    ...
    if (element === null || element === void 0 ? void 0 : (_element$type = element.type) === null || _element$type === void 0 ? void 0 : _element$type.isProCard) {
      ...
      var columnClassName = (0, _classnames.default)(["".concat(prefixCls, "-col")], hashId, (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-split-vertical"), split === 'vertical' && index !== childrenArray.length - 1), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-split-horizontal"), split === 'horizontal' && index !== childrenArray.length - 1), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls, "-col-").concat(span), typeof span === 'number' && span >= 0 && span <= 24), _classNames));
      var wrappedElement = wrapSSR((0, _jsxRuntime.jsx)("div", {
  ...
  var cardCls = (0, _classnames.default)("".concat(prefixCls), className, hashId, (_classNames2 = {}, (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-border"), bordered), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-box-shadow"), boxShadow), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-contain-card"), containProCard), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-loading"), loading), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-split"), split === 'vertical' || split === 'horizontal'), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-ghost"), ghost), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-hoverable"), hoverable), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-size-").concat(size), size), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-type-").concat(type), type), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-collapse"), collapsed), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls, "-checked"), checked), _classNames2));
  var bodyCls = (0, _classnames.default)("".concat(prefixCls, "-body"), hashId, (_classNames3 = {}, (0, _defineProperty2.default)(_classNames3, "".concat(prefixCls, "-body-center"), layout === 'center'), (0, _defineProperty2.default)(_classNames3, "".concat(prefixCls, "-body-direction-column"), split === 'horizontal' || direction === 'column'), (0, _defineProperty2.default)(_classNames3, "".concat(prefixCls, "-body-wrap"), wrap && containProCard), _classNames3));
  ...
  var loadingDOM = /*#__PURE__*/_react.default.isValidElement(loading) ? loading : (0, _jsxRuntime.jsx)(_Loading.default, {
    prefix: prefixCls,
  ...
  var collapsibleButton = collapsible && controlCollapsed === undefined && (collapsibleIconRender ? collapsibleIconRender({
    collapsed: collapsed
  }) : (0, _jsxRuntime.jsx)(_icons.RightOutlined, {
    rotate: !collapsed ? 90 : undefined,
    className: "".concat(prefixCls, "-collapsible-icon ").concat(hashId)
  }));
  return wrapSSR((0, _jsxRuntime.jsxs)("div", (0, _objectSpread2.default)((0, _objectSpread2.default)({
    className: cardCls,
    style: style,
    ref: ref,
    ...
    children: [(title || extra || collapsibleButton) && (0, _jsxRuntime.jsxs)("div", {
      className: (0, _classnames.default)("".concat(prefixCls, "-header"), hashId, (_classNames4 = {}, (0, _defineProperty2.default)(_classNames4, "".concat(prefixCls, "-header-border"), headerBordered || type === 'inner'), (0, _defineProperty2.default)(_classNames4, "".concat(prefixCls, "-header-collapsible"), collapsibleButton), _classNames4)),
      style: headStyle,
      ...
      children: [(0, _jsxRuntime.jsxs)("div", {
        ...
        children: [collapsibleButton, (0, _jsxRuntime.jsx)(_proUtils.LabelIconTip, {
          label: title,
          tooltip: tooltip || tip,
          subTitle: subTitle
        })]
    ...
    }), tabs ? (0, _jsxRuntime.jsx)("div", {
      className: "".concat(prefixCls, "-tabs ").concat(hashId),
      children: (0, _jsxRuntime.jsx)(_antd.Tabs, (0, _objectSpread2.default)((0, _objectSpread2.default)({
    ...
    }), actions ? (0, _jsxRuntime.jsx)(_Actions.default, {
      actions: actions,
      prefixCls: prefixCls
    }) : null]
  })));
