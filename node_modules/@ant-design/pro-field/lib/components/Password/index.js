...
var FieldPassword = function FieldPassword(_ref, ref) {
  ...
  if (mode === 'read') {
    ...
    if (text) {
      dom = (0, _jsxRuntime.jsxs)(_antd.Space, {
        children: [(0, _jsxRuntime.jsx)("span", {
          ...
          children: open ? (0, _jsxRuntime.jsx)(_icons.EyeOutlined, {}) : (0, _jsxRuntime.jsx)(_icons.EyeInvisibleOutlined, {})
        })]
      });
    }
    if (render) {
  ...
  if (mode === 'edit' || mode === 'update') {
    var _dom = (0, _jsxRuntime.jsx)(_antd.Input.Password, (0, _objectSpread2.default)({
