...
var FieldTimePicker = function FieldTimePicker(_ref, ref) {
  ...
  var _useDatePickerStyle = (0, _DatePicker.useDatePickerStyle)(),
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      ...
      _dom = wrapSSR((0, _jsxRuntime.jsxs)("div", {
        ...
        children: [(0, _jsxRuntime.jsx)(_antd.TimePicker, (0, _objectSpread2.default)((0, _objectSpread2.default)({
          value: dayValue,
          format: format,
          ref: ref
        }, fieldProps), {}, {
      ...
      _dom = (0, _jsxRuntime.jsx)(_antd.DatePicker.TimePicker, (0, _objectSpread2.default)((0, _objectSpread2.default)({
        ref: ref,
        format: format,
...
var FieldTimeRangePickerComponents = function FieldTimeRangePickerComponents(_ref2, ref) {
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var momentValue = (0, _proUtils.parseValueToDay)(value, finalFormat);
    var _dom2 = (0, _jsxRuntime.jsx)(_antd.TimePicker.RangePicker, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      ref: ref,
      format: format,
      bordered: plain === undefined ? true : !plain
    }, fieldProps), {}, {
...
var FieldTimeRangePicker = /*#__PURE__*/_react.default.forwardRef(FieldTimeRangePickerComponents);
