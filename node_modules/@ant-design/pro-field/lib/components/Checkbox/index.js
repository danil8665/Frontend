...
var FieldCheckbox = function FieldCheckbox(_ref, ref) {
  ...
  if (mode === 'read') {
    ...
    if (render) {
      return render(rest.text, (0, _objectSpread3.default)({
        mode: mode
      }, rest.fieldProps), (0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
        children: dom
      })) || null;
    }
  ...
  if (mode === 'edit') {
    ...
    var _dom = wrapSSR((0, _jsxRuntime.jsx)(_antd.Checkbox.Group, (0, _objectSpread3.default)((0, _objectSpread3.default)({}, rest.fieldProps), {}, {
