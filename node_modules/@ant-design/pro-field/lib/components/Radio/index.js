...
var FieldRadio = function FieldRadio(_ref, ref) {
  ...
  var _useStyle = (0, _proUtils.useStyle)('FieldRadioRadio', function (token) {
      return (0, _defineProperty2.default)({}, ".".concat(layoutClassName, "-vertical"), (0, _defineProperty2.default)({}, "".concat(token.antCls, "-radio-wrapper"), {
        display: 'block',
        marginInlineEnd: 0
      }));
    }),
  ...
  if (mode === 'edit') {
    ...
    var _dom = wrapSSR((0, _jsxRuntime.jsx)(_antd.Radio.Group, (0, _objectSpread3.default)((0, _objectSpread3.default)({
      ref: radioRef,
      optionType: radioType
    }, rest.fieldProps), {}, {
      className: (0, _classnames.default)((_rest$fieldProps = rest.fieldProps) === null || _rest$fieldProps === void 0 ? void 0 : _rest$fieldProps.className, hashId, "".concat(layoutClassName, "-").concat(rest.fieldProps.layout || 'horizontal')),
      options: options
    })));
    if (renderFormItem) {
