  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      ...
      _dom = (0, _jsxRuntime.jsxs)("div", {
        ...
        children: [(0, _jsxRuntime.jsx)(_antd.DatePicker, (0, _objectSpread2.default)((0, _objectSpread2.default)({
          picker: picker,
          showTime: showTime,
          format: format,
          ref: ref
      ...
      _dom = (0, _jsxRuntime.jsx)(_antd.DatePicker, (0, _objectSpread2.default)((0, _objectSpread2.default)({
        picker: picker,
        showTime: showTime,
        format: format,
        placeholder: placeholder,
