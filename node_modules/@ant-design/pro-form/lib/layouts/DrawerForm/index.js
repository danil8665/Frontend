...
var _excluded = ["children", "trigger", "onVisibleChange", "drawerProps", "onFinish", "submitTimeout", "title", "width", "onOpenChange", "visible", "open"];
function DrawerForm(_ref) {
  ...
  var resetFields = (0, _react.useCallback)(function () {
    ...
    // 重置表单
    if (form && (drawerProps === null || drawerProps === void 0 ? void 0 : drawerProps.destroyOnClose)) {
      form.resetFields();
    }
  ...
  var contentRender = (0, _react.useCallback)(function (formDom, submitter) {
    return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [formDom, footerRef.current && submitter ? (0, _jsxRuntime.jsx)(_react.default.Fragment, {
  ...
  return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [(0, _jsxRuntime.jsx)(_antd.Drawer, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({
      title: title,
      width: width || 800
      ...
      footer: rest.submitter !== false && (0, _jsxRuntime.jsx)("div", {
        ref: footerDomRef,
        style: {
          display: 'flex',
      ...
      children: (0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
        children: (0, _jsxRuntime.jsx)(_BaseForm.BaseForm, (0, _objectSpread2.default)((0, _objectSpread2.default)({
          ...
          onFinish: function () {
            var _onFinish = (0, _asyncToGenerator2.default)( /*#__PURE__*/(0, _regeneratorRuntime2.default)().mark(function _callee3(values) {
              var result;
