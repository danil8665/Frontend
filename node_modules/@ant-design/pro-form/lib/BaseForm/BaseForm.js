...
function BaseFormComponents(props) {
  ...
  var sizeContextValue = (0, _react.useContext)(_antd.ConfigProvider.SizeContext);
  /** 同步 url 上的参数 */
  ...
  return (0, _jsxRuntime.jsx)(_proUtils.ProFormContext.Provider, {
    value: formatValues,
    children: (0, _jsxRuntime.jsx)(_antd.ConfigProvider.SizeContext.Provider, {
...
function BaseForm(props) {
  ...
  var _useStyle = (0, _proUtils.useStyle)('ProForm', function (token) {
      return (0, _defineProperty2.default)({}, ".".concat(prefixCls), (0, _defineProperty2.default)({
        '*': {
          boxSizing: 'border-box'
        }
      }, "> div:not(".concat(token.proComponentsCls, "-form-light-filter)"), {
        '.pro-field': {
          maxWidth: '100%',
          // 适用于短数字，短文本或者选项
          '&-xs': {
  ...
  if (!initialData && props.request) {
    return (0, _jsxRuntime.jsx)("div", {
      ...
      children: (0, _jsxRuntime.jsx)(_antd.Spin, {})
    });
  }
  return wrapSSR((0, _jsxRuntime.jsx)(_EditOrReadOnlyContext.EditOrReadOnlyContext.Provider, {
    value: {
      mode: props.readonly ? 'read' : 'edit'
    },
    children: (0, _jsxRuntime.jsx)(_proProvider.ProConfigProvider, {
      needDeps: true,
      children: (0, _jsxRuntime.jsx)(_FieldContext.default.Provider, {
        value: {
          ...
          setFieldValueType: function setFieldValueType(name, _ref3) {
            var _ref3$valueType = _ref3.valueType,
              valueType = _ref3$valueType === void 0 ? 'text' : _ref3$valueType,
        ...
        children: (0, _jsxRuntime.jsx)(_List.FormListContext.Provider, {
          value: {},
          children: (0, _jsxRuntime.jsx)(_antd.Form, (0, _objectSpread4.default)((0, _objectSpread4.default)({
