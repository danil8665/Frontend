...
var BaseProFormCaptcha = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  ...
  return (0, _jsxRuntime.jsxs)("div", {
    ...
    ref: ref,
    children: [(0, _jsxRuntime.jsx)(_antd.Input, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, fieldProps), {}, {
      style: {
        flex: 1,
        transition: 'width .3s',
        marginRight: 8
          ...
          return (0, _regeneratorRuntime2.default)().wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 4:
                  mobile = form.getFieldValue([phoneName].flat(1));
                  _context2.next = 7;
