...
function BetaSchemaForm(props) {
  ...
  var rest = (0, _react.useMemo)(function () {
    return (0, _omit.default)(restProps, ['formRef']);
  }, [restProps]);
  var formRef = (0, _react.useRef)(props.form || formInstance || form);
  ...
  var genItems = (0, _react.useCallback)(function (items) {
    return items.filter(function (originItem) {
      ...
      var _item$dataIndex;
      var title = (0, _proUtils.runFunction)(originItem.title, originItem, 'form', (0, _jsxRuntime.jsx)(_proUtils.LabelIconTip, {
  ...
  var formChildrenDoms = (0, _react.useMemo)(function () {
   ...
   */
  var specificProps = (0, _react.useMemo)(function () {
  ...
  return (0, _jsxRuntime.jsx)(FormRenderComponents, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, specificProps), rest), {}, {
