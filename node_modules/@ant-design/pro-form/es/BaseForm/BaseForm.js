...
function BaseFormComponents(props) {
  ...
  var sizeContextValue = useContext(ConfigProvider.SizeContext);
  /** 同步 url 上的参数 */
  ...
  return _jsx(ProFormContext.Provider, {
    value: formatValues,
    children: _jsx(ConfigProvider.SizeContext.Provider, {
...
function BaseForm(props) {
  ...
  var _useStyle = useStyle('ProForm', function (token) {
      return _defineProperty({}, ".".concat(prefixCls), _defineProperty({
        '*': {
  ...
  return wrapSSR(_jsx(EditOrReadOnlyContext.Provider, {
    value: {
    ...
    children: _jsx(ProConfigProvider, {
      ...
      children: _jsx(FieldContext.Provider, {
        ...
        children: _jsx(FormListContext.Provider, {
          value: {},
          children: _jsx(Form, _objectSpread(_objectSpread({
