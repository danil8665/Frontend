...
function ProList(props) {
  ...
  return wrapSSR((0, _jsxRuntime.jsx)(_proTable.default, (0, _objectSpread2.default)((0, _objectSpread2.default)({
    tooltip: tooltip
  }, rest), {}, {
    actionRef: actionRef,
    ...
    tableViewRender: function tableViewRender(_ref) {
      ...
      return (0, _jsxRuntime.jsx)(_ListView.default, {
        grid: grid,
...
function BaseProList(props) {
  return (0, _jsxRuntime.jsx)(ProList, (0, _objectSpread2.default)({
    cardProps: false,
    search: false,
    toolBarRender: false
  }, props));
