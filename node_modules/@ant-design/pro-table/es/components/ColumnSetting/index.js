...
function ColumnSetting(props) {
  ...
  var intl = useIntl();
  var _useContext4 = useContext(ConfigProvider.ConfigContext),
  ...
  return wrapSSR(_jsx(Popover, {
    ...
    title: _jsxs("div", {
      ...
      }) : null, (props === null || props === void 0 ? void 0 : props.extra) ? _jsx(Space, {
        size: 12,
        align: "center",
    ...
    children: props.children || _jsx(Tooltip, {
