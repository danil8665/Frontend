...
var isMergeCell = function isMergeCell(dom) {
  var _dom$props;
  return dom && (0, _typeof2.default)(dom) === 'object' && (dom === null || dom === void 0 ? void 0 : (_dom$props = dom.props) === null || _dom$props === void 0 ? void 0 : _dom$props.colSpan);
};
/**
...
function sortData(_ref, data) {
  ...
  if (oldIndex !== newIndex) {
    var newData = (0, _proUtils.arrayMoveImmutable)({
      array: (0, _toConsumableArray2.default)(data || []),
      fromIndex: oldIndex,
      toIndex: newIndex
    }).filter(function (el) {
      return !!el;
    });
    return (0, _toConsumableArray2.default)(newData);
  }
