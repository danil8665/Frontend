...
function EditableTable(props) {
  ...
  var preData = (0, _proUtils.usePrevious)(props.value);
  ...
  (0, _react.useImperativeHandle)(editableFormRef, function () {
    ...
    return (0, _objectSpread2.default)((0, _objectSpread2.default)({}, formRef.current), {}, {
      ...
      setRowData: function setRowData(rowIndex, data) {
        ...
        var updateValues = (0, _set.default)(oldTableDate, rowKeyName, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, getRowData(rowIndex)), data || {}));
  ...
  (0, _react.useEffect)(function () {
    ...
    value.forEach(function (current, index) {
      ...
      (_formRef$current6 = formRef.current) === null || _formRef$current6 === void 0 ? void 0 : _formRef$current6.setFieldsValue((0, _defineProperty2.default)({}, getRowKey(current, index), current));
    }, {});
  ...
  var creatorButtonDom = (0, _react.useMemo)(function () {
    ...
    return recordCreatorProps !== false && (0, _jsxRuntime.jsx)(RecordCreator, {
        ...
        components: {
          header: {
            wrapper: function wrapper(_ref2) {
              ...
              return (0, _jsxRuntime.jsxs)("thead", {
                className: className,
                children: [children, (0, _jsxRuntime.jsxs)("tr", {
                  style: {
                    position: 'relative'
                  },
  ...
  if ((props === null || props === void 0 ? void 0 : props.onValuesChange) || ((_props$editable4 = props.editable) === null || _props$editable4 === void 0 ? void 0 : _props$editable4.onValuesChange) ||
  // 受控模式需要触发 onchange
  props.controlled && (props === null || props === void 0 ? void 0 : props.onChange)) {
    editableProps.onValuesChange = newOnValueChange;
  }
  return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [(0, _jsxRuntime.jsx)(EditableTableActionContext.Provider, {
      value: actionRef,
      children: (0, _jsxRuntime.jsx)(_Table.default, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({
        search: false,
        options: false,
        pagination: false,
        rowKey: rowKey,
    ...
    }), props.name ? (0, _jsxRuntime.jsx)(_proForm.ProFormDependency, {
      name: [props.name],
      children: function children(changeValue) {
        ...
        var changeItem = list === null || list === void 0 ? void 0 : list.find(function (item, index) {
          return !(0, _proUtils.isDeepEqualReact)(item, preData === null || preData === void 0 ? void 0 : preData[index]);
        });
...
function FieldEditableTable(props) {
  ...
  if (!props.name) return (0, _jsxRuntime.jsx)(EditableTable, (0, _objectSpread2.default)({}, props));
  return (0, _jsxRuntime.jsx)(_antd.Form.Item, (0, _objectSpread2.default)((0, _objectSpread2.default)({
    style: {
      maxWidth: '100%'
    }
  }, props === null || props === void 0 ? void 0 : props.formItemProps), {}, {
    name: props.name,
    children: (0, _jsxRuntime.jsx)(EditableTable, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
