...
const AddProduct: React.FC = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    await fetch(`https://backend-dixi-00461a80fa26.herokuapp.com/upload`, {
      method: "POST",
      body: formData,
    });
    form.resetFields();
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      <Sider
        ...
        collapsedWidth={60}
      >
        <Menu defaultSelectedKeys={["2"]} mode="vertical" theme={theme}>
          <Menu.Item key={1}>
            <Link href={"/"}>
              <HomeOutlined />
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Главная{" "}
              ...
              <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} justify="center">
                ...
                >
                  ...
                  <Form.Item noStyle shouldUpdate>
                    {({ getFieldsValue }) => {
                      const { manufacturer, name, picture, discount, price } =
                        getFieldsValue();
                      const formIsComplete =
                        !!manufacturer && !!name && !!discount && !!price;
                      return (
                        <Button
                          type="primary"
                          htmlType="submit"
